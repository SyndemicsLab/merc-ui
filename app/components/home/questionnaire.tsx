        ...
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogContent className="rounded-2xl text-left p-[20px] max-w-[600px] min-w-[400px] bg-white dialog-root">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Your answers to the following questions are optional and
                        serve only to help us understand the way this tool is
                        being used. This information will let us know how we can
                        best update and expand the tool to be as useful as
